...
<nav id="sidebar" class="sidebar-wrapper">
    <div class="sidebar-content">
        ...
        <div class="sidebar-header">
            <div class="user-pic">
                <img class="img-responsive img-rounded" src="assets/images/user.png" alt="USER">
            </div>
            <div class="user-info">
                <span class="user-name"><b><?php echo $name?></b>
                </span>
        ...
        <div class="sidebar-search">
            <div>
                <div class="input-group">
                    <input type="text" name="search" class="form-control search-menu" placeholder="Search..." id="search">
