...
$cookieEmailAdmin = (isset($_COOKIE['CookieEmailAdmin'])) ? base64_decode($_COOKIE['CookieEmailAdmin']) : '';
    ...
    if(isset($_POST['email']) && isset($_POST['password'])){
        ...
        if(isset($_POST['remember-me'])){
            ...
            setCookie('CookieEmailAdmin', base64_encode($email), $expira);
       }
        
        $session = new SessionAdmin($email,$password);
        $session->login();
				...
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter username">
						<input class="input100" type="text" name="email" placeholder="Email"
							value="<?php if(!empty($cookieEmailAdmin)){echo $cookieEmailAdmin;}?>">
					...
					<div class="text-center pt-3">
						<a class="txt1" href="redefinir_senha.php">
							Esqueceu a senha?
						</a>
					</div>
				</form>
